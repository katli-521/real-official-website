      ...
      <div style={{ maxWidth: '880px', margin: '0 auto', padding: '4rem 2rem' }}>
        ...
        <div style={{ borderTop: '1px solid oklch(0.18 0.03 265)', paddingTop: '2.5rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.2rem' }}>
            ...
            <a
              href="https://silent-hill-f.vercel.app"
              style={{ fontFamily: 'monospace', fontSize: '9px', color: 'oklch(0.55 0.10 250)', letterSpacing: '0.1em', border: '1px solid oklch(0.25 0.06 250)', padding: '2px 6px', textTransform: 'uppercase', textDecoration: 'none' }}
            >
              details →
            </a>
          </div>
